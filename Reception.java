...
public class Reception extends JFrame implements ActionListener{
    JButton b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,b12;
     Reception(){
        ...
        ImageIcon img1 = new ImageIcon(ClassLoader.getSystemResource("icons/fourth.jpg"));
        Image img2 = img1.getImage().getScaledInstance(500,470,Image.SCALE_DEFAULT);//to scale img completely inside the box
        ImageIcon img3 = new ImageIcon(img2);
        JLabel l2 = new JLabel(img3);
        l2.setBounds(250,30,500,470);
        add(l2);

         getContentPane().setBackground(Color.WHITE);

         setLayout(null);
         setBounds(250,100,800,560);//according to my screen size asus XF09
         setVisible(true);
